...
How to run
python3 -m memory_profiler tacit-app_resistance.py /Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/data/to_be_tacited/sample_data False
python3 -m memory_profiler tacit-app_resistance.py /Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/data/to_be_tacited/fall_2020_and_spring_2020 False
python3 -m memory_profiler tacit-app_social_2.py /Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/data/to_be_tacited/batch_2 False
...
if __name__ == "__main__":
    ...
    for theme_key, theme_val in themes.items():
        ...
        for i in filtered_input_dir:
            ...
            out_file_name = f"{output_path}/" + str(csv_name) + f"_{themes[4]}_tacited.xlsx"
            print("/Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/src/tacit/Resistance" + out_file_name)
            # print("HEY HERE", os.path.isfile(out_file_name))
            # print("HEY HERE", out_file_name)
            if overwrite == "False" and os.path.isfile("/Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/src/tacit/Resistance" + out_file_name):
