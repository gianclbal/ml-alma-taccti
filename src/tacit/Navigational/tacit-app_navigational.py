...
How to run
python3 -m memory_profiler tacit-app_navigational.py /Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/data/to_be_tacited/sample_data False
python3 -m memory_profiler tacit-app_navigational.py /Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/data/to_be_tacited/batch_2 False
python3 -m memory_profiler tacit-app_navigational.py /Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/data/to_be_tacited/batch_2 False
...
if __name__ == "__main__":
    ...
    # resistance_model = ktrain.load_predictor("/Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/saved_models/resistance_bert_base_cased_model_08092024_v1")
    navigational_model = ktrain.load_predictor("/Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/saved_models/navigational_bert_base_cased_model_08012024")
    models_dict = {
        # 2: familial_model,
        # 3: social_model,
        # 4: resistance_model,
        5: navigational_model
    }
    ...
    for theme_key, theme_val in themes.items():
        ...
        for i in filtered_input_dir:
            ...
            out_file_name = f"{output_path}/" + str(csv_name) + f"_{themes[5]}_tacited.xlsx"
            print("/Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/src/tacit/Navigational" + out_file_name)
            # print("HEY HERE", os.path.isfile(out_file_name))
            # print("HEY HERE", out_file_name)
            if overwrite == "False" and os.path.isfile("/Users/gbaldonado/Developer/ml-alma-taccti/ml-alma-taccti/src/tacit/Navigational" + out_file_name):
